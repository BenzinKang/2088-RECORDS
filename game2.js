...
class BackgroundSystem {
    ...
    generateParallaxSectors() {
        ...
        // 调暗墙体和屋顶配色，使其融入黄昏
        const fgWallColors = [
            '#beb8b0', '#b0b0ad', '#b5aea2', '#a1a6aa', // 原有墙体色（灰白米黄）
            '#947a6b', '#7a6a58', '#8f7783', '#627c85'  // 【新增】红棕墙、泥土色、紫灰墙、暗蓝绿墙体
        ]; 
        const fgRoofColors = [
            '#30373d', '#3e3d3b', '#262c36',             // 原有屋顶色（深灰黑）
            '#5c2e2b', '#1f3c4d', '#2b4737', '#4b3c5c'  // 【新增】暗红砖瓦、黛蓝瓦、墨绿瓦、暗紫瓦
        ]; 
        const awningColors = [
            '#1650a2', '#b34700', '#008055', '#a1241b', // 原有遮阳棚色（蓝、橙、绿、红）
            '#e6b800', '#cc0088', '#00cccc', '#ffffff'  // 【新增】金黄、霓虹粉、青蓝、纯白遮阳棚
        ]; 
